            ...
            NavigationStack {
                ZStack {
                    ...
                    VStack(spacing: 30) {
                        ...
                        if isOfflineMode {
                            Text("🌐 Offline Mode Enabled – Some features may be unavailable")
                                .font(.footnote)
                        ...
                        VStack(spacing: 20) {
                            HomeNavLink(
                                ...
                                destination: AddPlantView(), // ✅ This should work in both modes
                            ...
                            HomeNavLink(
                                title: "Encyclopedia",
                                systemImage: "book",
                                destination: EncyclopediaMenuView(),
                                namespace: navNamespace
                            )
